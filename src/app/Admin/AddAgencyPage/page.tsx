...
// // ✅ FormData ka type define karna best practice hai
...
//       // ✅ Save agencyId for dashboard usage
...
//         >
//           Add your agency details and start managing trips, approvals, and
//           receipts with ease.
//         </motion.p>
...
//                   className="w-full border border-gray-300 rounded-lg p-2 focus:border-blue-500 focus:ring focus:ring-blue-100 outline-none"
//                   required
//                 />
//                 <input
//                   type="email"
...
export default function AddAgencyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await axios.post(
        "http://localhost:5000/api/agencies",
        { ...formData, agencyId },  // ✅ agencyId bhi send
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
          ...
          >
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input type="email" name="email" placeholder="Email" value={formData.email} onChange={handleChange} className="w-full border rounded-lg p-2" required />
