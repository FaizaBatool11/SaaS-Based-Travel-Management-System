...
export default function TripDetail() {
  ...
  // ✅ Fetch trips based on active token
  // useEffect(() => {
  ...
  //   };
  //   fetchTrips();
  // }, [agencyId]); // agencyId change hone pe bhi reload hoga
  // ✅ Fetch trips based on activeAgencyId (query param)
useEffect(() => {
  const fetchTrips = async () => {
    try {
      setLoading(true);
  ...
  //       setIsEditing(false);
  //     } else {
  //       // 👇 AgencyId token ke andar already aa rahi hai
