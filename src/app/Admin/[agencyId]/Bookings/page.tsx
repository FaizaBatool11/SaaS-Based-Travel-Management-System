...
//       // ✅ enrich booking with passenger & trip names locally
...
//     try {
//       const res = await axios.patch(
//         `http://localhost:5000/api/bookings/updateBooking/${editingBooking.id}`,
//         {
...
//             {/* Buttons */}
//             <div className="flex justify-end gap-2">
//               <button onClick={() => setShowUpdateModal(false)} className="px-4 py-2 rounded-lg border">
//                 Cancel
//               </button>
//               <button
